# hook-violation fixture for zeugnis

An active remediation-scope lock (`analysis/zeugnis/remediation_scope.json`)
...
No `_GIT_INIT` needed — zeugnis's hooks do not check git cleanliness.
