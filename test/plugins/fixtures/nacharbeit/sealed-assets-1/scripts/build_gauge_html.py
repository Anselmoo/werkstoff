#!/usr/bin/env python3
"""Render gauge-viewer.html with a report and the design tokens injected.

Usage: build_gauge_html.py <report.json> [--out gauge-report.html]
...
TEMPLATE = HERE.parent / "assets" / "gauge-viewer.html"
...
def main():
    ...
    ap.add_argument("--out", default="gauge-report.html")
    a = ap.parse_args()
    try:
