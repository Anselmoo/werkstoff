#!/usr/bin/env python3
"""Render burn-viewer.html with a report and the design tokens injected.

Usage: build_burn_html.py <report.json> [--out burn-report.html]
...
TEMPLATE = HERE.parent / "assets" / "burn-viewer.html"
...
def main():
    ...
    ap.add_argument("--out", default="burn-report.html")
    a = ap.parse_args()
    try:
