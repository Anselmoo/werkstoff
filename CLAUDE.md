...
python3 test/plugins/test-lint-prompts.py                # shim: nacharbeit's linter asserts itself (every rule planted + blanked -- `nacharbeit_lint.py --count` for how many) -- run before trusting it
