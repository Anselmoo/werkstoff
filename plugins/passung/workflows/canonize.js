export const meta = {
  ...
  phases: [
    ...
    { title: 'Divergent sites', detail: 'per-dimension site catalog for /passung-align' },
  ],
}
...
if (!area) {
  throw new Error(
    'passung-canonize workflow requires args: {area: "<area-dir>", dimensionPattern?: "<glob>", maxRounds?: number}',
  )
}
