export const meta = {
  ...
  whenToUse:
    'Invoked by /passung-scan when the Workflow tool is available. Requires args {area, conventionPattern?}. Returns structured divergence-dimension cards — the calling session writes CONSISTENCY_SCAN.md and consistency.json from them.',
  phases: [
...
if (!area) {
  throw new Error('passung-scan workflow requires args: {area: "<area-dir>", conventionPattern?: "<glob>"}')
}
