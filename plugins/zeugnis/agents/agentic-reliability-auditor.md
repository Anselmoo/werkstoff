...
4. `excessive-tool-grant` — an agent's declared `tools:` frontmatter
   ...
   role does not require. This is the ONLY category zeugnis may ever mark
...
the calling skill should route the finding to `zeugnis-remediator`
