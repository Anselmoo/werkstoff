...
2. Run:
   ...
   10-second default.
3. The script writes `analysis/zeugnis/reports/PREFLIGHT.md` and
   `analysis/zeugnis/preflight_summary.json` and prints a JSON summary of the four
