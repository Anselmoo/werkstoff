...
3. Optionally, for judgment calls the deterministic parser can't make on
   ...
   `${CLAUDE_PLUGIN_ROOT}/../analysis/zeugnis/tmp/agent_findings.json` (or any
...
4. Run:
   ...
   faith), and writes `analysis/zeugnis/reports/DEPENDENCY_AUDIT.md` and
   `analysis/zeugnis/dependency_audit_summary.json` in the shared finding schema.
