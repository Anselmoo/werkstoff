"""zeugnis-cycle's per-repo finding ledger: cross-pass state (open/closed/
escalated findings, pass history) persisted at analysis/zeugnis/ledger.json."""
import json
import os
...
def resolve_max_passes(max_passes):
    # The "never above 20" ceiling in zeugnis-cycle's SKILL.md is guidance to
