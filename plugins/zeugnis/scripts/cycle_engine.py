#!/usr/bin/env python3
"""zeugnis-cycle engine: the bounded self-optimization loop's enforcement
layer. The orchestrating Claude session drives the actual work (dispatching
domain-audit skills/agents and zeugnis-remediator per pass); this script is
...
def cmd_record_pass_result(args) -> int:
    ...
    log_path = safe_output_path(repo_root, "reports/ZEUGNIS_CYCLE.md")
