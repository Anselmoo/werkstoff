#!/usr/bin/env python3
"""Tests for zeugnis-status's burndown chart builder.
...
Run: python3 plugins/zeugnis/scripts/test_build_burndown_html.py -v
"""
...
class Repo:
    """A throwaway repo with a hand-seeded analysis/zeugnis/ledger.json."""
...
class ReportConformanceTests(unittest.TestCase):
    ...
    def test_head_carries_csp_and_canonical_title(self):
        ...
        self.assertIn("<title>zeugnis \u2014 burndown</title>", html)
