#!/usr/bin/env python3
"""zeugnis-preflight: runs all five readiness checks unconditionally (rule:
...
Writes analysis/zeugnis/reports/PREFLIGHT.md and analysis/zeugnis/preflight_summary.json.
...
def render_markdown(check_results: list, verdicts: dict) -> str:
    lines = ["# zeugnis Preflight", "", "## Checks", "", "| Check | Status | Detail |", "|---|---|---|"]
    for r in check_results:
