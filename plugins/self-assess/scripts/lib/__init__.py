"""self-assess's internal support library.
...
a fresh implementation grounded in call-site evidence (self_assess_cli.py,
every skill's SKILL.md, and hooks/test_guard_target_edit.py), not a restored
original.
"""
