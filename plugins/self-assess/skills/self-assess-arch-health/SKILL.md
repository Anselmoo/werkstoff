...
Workflow({
  ...
  args: { repoPath: "<repo root, usually '.'>", stageGraph: <parsed contents of stage_graph.json>, symbolIndexPath: <resolved snapshot dir, or null>, skipVerification: <from settings, default false> }
})
```
