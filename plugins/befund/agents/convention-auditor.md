...
- **Capped rule-set audit.** befund-lint-audit hands you a dispatched (already capped)
...
1. Extract-Find-Verify: work only from rules that are explicitly documented in the source file
   you were given (house-rules.md, CLAUDE.md, CONTRIBUTING, ADRs, linter config) -- never invent
   a convention because it "seems like good practice."
...
- Do not invent conventions not documented in CLAUDE.md/CONTRIBUTING/ADRs/linter config.
