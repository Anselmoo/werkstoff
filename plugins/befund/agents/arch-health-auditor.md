...
- **God-module confirmation.** befund-arch-health's mechanical fan-in check flags a
...
[
  {
    "type": "cycle",
    "members": ["stage:auth", "stage:billing"],
    "evidence": ["src/auth/session.py:14", "src/billing/entitlements.py:9"],
    "verified": true
  },
  {
    "type": "god-module",
