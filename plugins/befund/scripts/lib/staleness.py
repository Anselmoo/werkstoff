...
# The two data artifacts befund-arch-health and befund-transform-brief
# actually depend on (per befund-stage-map's own SKILL.md) -- deliberately
...
def stage_map_fresh(output_abs, repo):
    """Whether befund-autopilot may SKIP re-running befund-stage-map
