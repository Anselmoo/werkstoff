#!/usr/bin/env python3
"""Tests for befund-autopilot's stage-map freshness check.

Reproduces the Phase 2 benchmark finding (docs/plugin-benchmark-phase2-
results.md, SA-1): befund-autopilot always re-ran befund-stage-map
...
Run: python3 plugins/befund/scripts/lib/test_staleness.py
"""
...
class StageMapFreshRepo:
    ...
    analysis/befund output dir, so tests can construct real
    ...
    def __init__(self):
        ...
        self.output_abs = os.path.join(self.root, "analysis", "befund")
...
class StageMapFreshTests(unittest.TestCase):
    ...
    def test_not_a_git_repo_is_not_fresh(self):
        with tempfile.TemporaryDirectory() as d:
            output_abs = os.path.join(d, "analysis", "befund")
