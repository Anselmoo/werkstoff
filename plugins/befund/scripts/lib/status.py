"""Build befund-status's dashboard from what's actually on disk --
...
SIDECAR_FILES = {
    "befund-docs-drift": "docs_drift_summary.json",
    "befund-ci-topology": "ci_topology_summary.json",
    "befund-lint-audit": "lint_audit_summary.json",
    "befund-code-idiom": "code_idiom_summary.json",
    "befund-extract-rules": "business_rules_summary.json",
    "befund-arch-health": "arch_health_summary.json",
    "befund-ui-audit": "ui_audit_summary.json",
}
...
# recommend_transform_brief() (running befund-stage-map is not itself a
...
# user asking "where does befund stand" (Phase 2 benchmark finding
...
STRUCTURAL_SIDECAR_FILES = {
    "befund-stage-map": "stage_map_summary.json",
    "befund-complexity-score": "complexity_score_summary.json",
    "befund-transform-brief": "transform_brief_summary.json",
}
