...
What this file carries instead: the **names** (not copyrightable), and matrize's own
...
extracted while assets may not be copied — and this corpus is where matrize is first
