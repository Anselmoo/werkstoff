...
`references/principle-vocabulary.md` carries names, links and matrize's own one-line
...
This plugin's own first reference corpus is R2/R3 material. If matrize ever bundles it,
matrize has violated its own invariant on its very first run. Treat that as the
