...
Regression case for `quality-assertion-audit`'s core detection scenario: a
...
**Expected result from `quality-assertion-audit`:** a High-severity
...
`quality-assertion-audit`'s finder/verifier agents, not necessarily
