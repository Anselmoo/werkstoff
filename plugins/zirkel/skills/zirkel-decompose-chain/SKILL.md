...
description: >-
  ...
  what", or the Decompose phase of zirkel-solve.
---
...
only inside zirkel-solve's single end-of-pipeline state write. Unlike Clarify and
Explore, zirkel-solve's Decompose step performs no prior-run reuse check, so a
