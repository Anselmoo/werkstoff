---
name: zirkel-negotiate-tradeoffs
description: >-
  After zirkel-explore-branches has selected a winner, synthesizes a hybrid that
...
**MUST NOT run before `zirkel-explore-branches` has already selected a winner.**
...
zirkel). **If the guard refuses, do not present the hybrid** — report that no
