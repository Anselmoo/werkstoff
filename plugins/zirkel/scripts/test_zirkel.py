#!/usr/bin/env python3
"""Self-contained test suite for zirkel_lib guards.

Run: python3 scripts/test_zirkel.py
...
# --- validate_state's optional "explore" artifact (zirkel.py, not zirkel_lib,
#     but exercised here via subprocess since zirkel.py's own dispatch table
#     is what actually wires state-write/state-find/state-read together) ---
COMPASS_PY = os.path.join(os.path.dirname(os.path.abspath(__file__)), "zirkel.py")
