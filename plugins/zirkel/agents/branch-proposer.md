...
description: >-
  ...
  Dispatched in parallel by zirkel-explore-branches so no branch anchors the
...
- **MUST NOT import codebase facts without verification.** If your approach rests
  ...
  `references/parallel-safe-research-protocol.md`) — `zirkel-explore-branches`
...
- Higher Risk means a larger raw number (Risk is never inverted in zirkel).
