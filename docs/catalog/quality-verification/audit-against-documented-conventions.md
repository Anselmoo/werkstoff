...
beats:
  ...
  - skill: "befund:convention-auditor"
  ...
  - skill: "passung:pattern-extractor"
...
grounding: "plugins/passung/README.md's own scope section routes documented conventions and version-deprecated idioms out of passung and into befund -- beats 1-2 and 3-4 above sit on opposite sides of that line by design, and a recipe that blurs it double-reports the same finding from both plugins."
dos:
...
undocumented half to passung to find and canonize, and only simplify once
