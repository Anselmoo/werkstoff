...
donts:
  - "Don't judge idioms against the newest available version -- befund-code-idiom judges against what the manifest already declares, not a target it hasn't reached."
