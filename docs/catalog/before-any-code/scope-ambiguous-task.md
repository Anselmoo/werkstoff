...
beats:
  - skill: "zirkel:zirkel-clarify-scope"
  ...
  - skill: "zirkel:zirkel-explore-branches"
  ...
  - skill: "zirkel:zirkel-negotiate-tradeoffs"
...
grounding: "\"make the plugins consistent\" splits on a documented boundary: `plugins/passung/README.md` lines 28-47 are headed \"Scope - read this before installing both this and befund\", and route documented conventions and version-deprecated idioms out of `passung` and into `befund`. Which of the two owns the request is a scoping answer, not an implementation detail."
dos:
