...
> Triggers `nacharbeit-lint`: the sabotage calibration first, then every mechanical rule (`nacharbeit_lint.py --count` prints how many); findings by rule and file, nothing applied.
