...
|---|---|---|---|---|---|---|---|---|---|
| `plan` | haiku | #1 | **PASS** | `self-assess:self-assess-stage-map` | 0 | 0 | 0 B | $0.26 | 61s |
| `plan` | haiku | #2 | **FAIL** | -- | 0 | 0 | 0 B | $0.24 | 65s |
| `plan` | sonnet | #1 | **FAIL** | -- | 0 | 0 | 0 B | $0.35 | 97s |
| `plan` | sonnet | #2 | **PASS** | `self-assess:self-assess-stage-map` | 0 | 0 | 0 B | $0.40 | 95s |

**Why the failing runs failed**

- expected skill(s) never fired: self-assess:self-assess-stage-map
