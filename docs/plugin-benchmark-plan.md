...
### cli-scaffold (`plugins/cli-scaffold/README.md`)
...
### compass (`plugins/compass/README.md`)
...
### confab (`plugins/confab/README.md`)
...
### cupertino (`plugins/cupertino/README.md`)
...
### self-assess (`plugins/self-assess/README.md`)
